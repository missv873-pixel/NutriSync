function getHealthTranslation(status) {
    ...
    const map = {
        en: {"Underweight":"Underweight","Normal Weight":"Normal Weight","Overweight":"Overweight","Obesity":"Obesity"},
        hi: {"Underweight":"कम वजन","Normal Weight":"सामान्य वजन","Overweight":"अधिक वजन","Obesity":"मोटापा"},
        mr: {"Underweight":"कमी वजन","Normal Weight":"सामान्य वजन","Overweight":"जास्त वजन","Obesity":"लठ्ठपणा"}
    };
...
function calculateBMI() {
    ...
    if (bmi < 18.5) {
        ...
        status = getHealthTranslation("Underweight");
        ...
        status = getHealthTranslation("Normal Weight");
        ...
        status = getHealthTranslation("Overweight");
        ...
        status = getHealthTranslation("Obesity");
